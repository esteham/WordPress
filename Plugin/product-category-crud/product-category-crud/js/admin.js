jQuery(document).ready(function($) 
{
    ...
    $(document).on('click','.edit-product', function(){
        ...
        $('#edit_unit_price').val(unit);
        $('#edit_selling_price').val(sell);
        $('#edit_total_stock').val(stock);
    ...
    $('#editProductForm').on('submit', function(e){
        ...
        const formData = new FormData(this);
        formData.append('action','pcc_update_product');
        ...
        $.ajax({
                ...
                success: function(res)
                {
                    if(res.success)
                    {
                        ...
                        $('#productMsg').html(`<div class="alert alert-success">Product Updated Successfully.</div>`);
                        loadProducts();
